...
class CMT(object):
	...
	def initialise(self, im_gray0, tl, br):
		...
		# im_gray0 = cv2.cvtColor(im_gray0, cv2.COLOR_BGR2GRAY)
		...
		#print type(keypoints_cv )
		#cv2.rectangle(im_draw,(tl[0],tl[1]),(br[0],br[1]),(255, 0, 0), 4)
		# for k in keypoints_cv:
			# cv2.circle(im_draw,(int(k.pt[0]),int(k.pt[1])),2,(0,255,0),-1)
		...
		# for k in selected_keypoints_cv:
			# cv2.circle(im_draw,(int(k.pt[0]),int(k.pt[1])),2,(0,255,0),-1)
		# cv2.imshow("T_chushi",im_draw)
		# cv2.waitKey()
		...
		# for k in background_keypoints_cv:
			# cv2.circle(im_draw,(int(k.pt[0]),int(k.pt[1])),2,(0,255,0),-1)
		# cv2.imshow("B_chushi",im_draw)
		# cv2.waitKey()
	...
	def process_frame(self, im_gray1):
		...
		# for k in range(tracked_keypoints.shape[0]):
			# cv2.circle( im_gray1,(int(tracked_keypoints[k][0]),int(tracked_keypoints[k][1])),2,(0,255,0),-1)
		# cv2.imshow("B_chushi1", im_gray1)
		# cv2.waitKey()
		...
		# for k in range(active_keypoints.shape[0]):
			# cv2.circle( im_gray1,(int(active_keypoints[k][0]),int(active_keypoints[k][1])),2,(0,255,0),-1)
		# cv2.imshow("B_chushi1", im_gray1)
		# cv2.waitKey(0)
